...
let withdrawMoney = (i) => {
    inquirer.prompt([
        ...
        if (obj4.amount <= accounts[i].balance) {
            ...
            updateData(i, accounts[i].balance); //Ye line remove karni hai
...
let transferMoney = (i) => {
    inquirer.prompt([
        ...
        if (j >= 0) {
                ...
                inquirer.prompt([
                    ...
                    if (obj5.amount <= accounts[i].balance) {
                        if (obj6.confirm === true) {
                            ...
                            updateData(i, accounts[i].balance, j, accounts[j].balance); //Ye line remove karni hai
                            // updateData(j,accounts[j].balance) //Ye line remove karni hai
            ...
            console.log("Invalid Account Number!");
            setTimeout(() => {
                transferMoney(i); //Ye line remove karni hai
                // accNumInput(accounts)
            }, 1000);
        }
    });
